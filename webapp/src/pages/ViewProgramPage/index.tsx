...
// helper hook placeholder for type inference
function useTrainer() {
  return null as any
}
...
export const ViewProgramPage = () => {
  ...
  if (isLoading || isFetching) {
    return <div className={css.loading}><span>Загрузка...</span></div>
  }
  ...
  return (
    <div className={css.page}>
      {/* Hero section: left media + right info */}
        ...
        <div className={css.heroInfo}>
          <div className={css.heroHeader}>
            <div>
              ...
              <h1 className={css.heroTitle}>{program.sport}</h1>
            </div>
            <button className={css.favoriteBtn} aria-label="В избранное">♡</button>
          </div>
