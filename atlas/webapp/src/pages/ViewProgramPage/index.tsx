      ...
      {hovered && (
        <div className={css.trainerPopup}>
          ...
          <div className={css.popupStats}>
            ...
            <div className={css.popupStat}>
              <span className={css.popupStatValue}>{trainer.clientsCount}</span>
              <span className={css.popupStatLabel}>клиентов</span>
            </div>
            <div className={css.popupStat}>
              <span className={css.popupStatValue}>{trainer.certificationsCount}</span>
              <span className={css.popupStatLabel}>сертификатов</span>
            </div>
          </div>
          ...
          {trainer.languages && trainer.languages.length > 0 && (
            <div className={css.popupDetail}>
              <span className={css.popupDetailIcon}>🌐</span>
              <span className={css.popupDetailText}>{trainer.languages.join(', ')}</span>
            </div>
          )}
    ...
    <div className={css.similarSection}>
      ...
      <div className={css.similarGrid}>
        {data.similar.map((p: any) => (
          ...
          >
            <div className={css.similarCardTop}>
            ...
            <p className={css.similarDesc}>{p.description}</p>
